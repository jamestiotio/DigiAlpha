...
For the CEC Verifier, we implemented a DPLL algorithm as the default algorithm. Further improvements could be obtained by implementing CDCL as the default algorithm, and topping up with an add-on of using Kosaraju's algorithm for 2-SAT Problems.
